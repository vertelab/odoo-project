...
from odoo.addons.web.controllers.home import module_boot, HomeStaticTemplateHelpers
...
class Http(models.AbstractModel):
    ...
    def session_info(self):
        ...
        if self.env.user.has_group('base.group_user') or self.env.user.has_group('customer_project_user.group_project_customer_user'):
